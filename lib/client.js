window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      ".dshGit_menuGraph{min-width:460px;max-width:760px}",
      ...
      ".dshGit_back{color:var(--dsw-alias-label-secondary);background:0 0;cursor:pointer;border:none;border-radius:6px;flex:none;padding:2px 6px;font:inherit;font-size:12px;line-height:16px}",
      ".dshGit_back:hover{background:var(--dsw-alias-interactive-bg-hover)}",
    ...
    function GitBranchAction({ sessionId, t, call }) {
      ...
      const refreshAction = view === "graph" ? () => void loadGraph() : () => void load(true)
      ...
      const header = React.createElement(
        ...
        view === "graph"
          ? React.createElement(
              "button",
              { type: "button", className: "dshGit_back", title: t("back"), onClick: () => { setView("list"); setGraphError(null) } },
              "‹ " + t("back"),
            )
          : React.createElement("span", { className: "dshGit_menuTitle", title: value.cwd }, menuTitle),
        React.createElement(
          "button",
          { type: "button", className: "dshGit_refresh", title: t("refreshHint"), onClick: refreshAction },
          t("refresh"),
        ),
      )
      ...
      if (view === "graph") {
        ...
        const graphContent =
          graphError !== null
            ? React.createElement("div", { className: "dshGit_error" }, t("failed", { message: graphError }))
            : graphLoading && commits.length === 0
              ? React.createElement("div", { className: "dshGit_graphLoading" }, t("graphLoading"))
              : commits.length > 0
                ? React.createElement(
                    "div",
                ...
                : React.createElement("div", { className: "dshGit_empty" }, t("graphEmpty"))
        body = graphContent
      } else {
        ...
        body = [
          ...
          React.createElement(
            "button",
            { type: "button", className: "dshGit_viewGraph", title: t("viewGraph"), onClick: () => { setView("graph"); void loadGraph() } },
      ...
      const menu = React.createElement(
        "div",
        { className: "dshGit_menu" + (view === "graph" ? " dshGit_menuGraph" : ""), role: "listbox", "aria-label": view === "graph" ? t("graphTitle") : t("menuTitle") },
        header,
        body,
      )
